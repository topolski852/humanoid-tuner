...
MAD5010_200KV = MotorSpec(
    ...
    velocity_limit=20.0,
    torque_filter_alpha=0.1454,
    rotor_inertia=3.301e-5,        # ESTIMATED from Berkeley 5010 (110KV) char
    ...
    notes=(
        "Rotor inertia scaled from Berkeley 5010 110KV char (same stator) — ESTIMATED, "
        "bench-measure before trusting. R from datasheet; L unpublished for 200KV."
    ),
)
